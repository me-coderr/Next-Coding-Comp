...
let applyFilters = () =>
{
    let elems = document.getElementsByClassName("filterType");

    Array.from(elems).forEach((filter) => 
    {
...
let execute_main = async (filterClicked) => 
{
    ...
    if(count === 0)
    {
        replaceAlert("For the time-being, there are no contests under the category : <br>" + filterClicked.getAttribute("name"));
